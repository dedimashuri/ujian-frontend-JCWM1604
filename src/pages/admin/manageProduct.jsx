...
class ManageProduct extends Component {
  ...
  onSaveEditClick =()=> {
    ...
    if (name && image && tahun && harga && deskripsi && categoryId) {
      axios 
      ...
      <div>
        ...
        <Modal size="lg" isOpen={this.state.modalEdit} toggle={this.toggleEdit}>
          ...
          <ModalBody>
            ...
            <input
              ...
              name="image"
              placeholder="Foto"
              value={this.state.editData.image}
              onChange={this.onEditChange}
            />
            <input
              className="form-control my-1"
              ...
              name="tahun"
              placeholder="Tahun"
              value={this.state.editData.tahun}
              onChange={this.onEditChange}
            />
            <InputGroup>
              <input
            ...
            <textarea
              ...
              name="deskripsi"
              placeholder="deskripsi"
              value={this.state.editData.deskripsi}
              cols="30"
              rows="10"
              onChange={this.onEditChange}
            ></textarea>
        ...
        <div className="mx-5 my-3">
          <div className="row">
            ...
            <div className="col-10 my-2" style={{ width: "40%" }}>
              <input
                type="search"
